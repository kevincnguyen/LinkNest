      ...
      <div className="flex flex-col justify-start items-start w-3/5">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <Link to="/admin/links" className="py-2">
            <button type="button" className="btn btn-wide sm:btn-sm md:btn-md lg:btn-lg btn-secondary text-left">
              Edit links
          ...
          <Link to="/admin/appearance" className="py-2">
            <button type="button" className="btn btn-wide sm:btn-sm md:btn-md lg:btn-lg btn-accent text-left">
              Edit appearance
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
